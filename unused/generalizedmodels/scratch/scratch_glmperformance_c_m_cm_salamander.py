...
exp, ombstimnr, dgstimnr = 'Kuehn', 13, 5
save = True
savedir = '/media/owncloud/20191021_labmeeting/'
...
fig1.suptitle('GLM performance for salamander cells')
fig1.show()
if save:
    fig1.savefig(savedir + 'glm_performance_salamander.pdf')