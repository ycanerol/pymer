...
data = np.load('/home/ycan/Downloads/csiplotting_mesomeso.npz')
...
ax3.set_xticks([0, 1])
ax3.set_xticklabels(['Mesopic 1', 'Mesopic 2'])
...
ax4.pie(distrib, labels=colorlabels, colors=colorcategories)
plf.subplottext('D', ax4, x=-0.2, y=1.025)


plt.subplots_adjust(hspace=.4, wspace=.4)
#texplot.savefig('polarityindexchange')
plt.savefig('/home/ycan/Documents/notes/2018-03-15/mesomesoPIchange.svg')
plt.show()