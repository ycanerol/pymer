...
ax.set_xlabel('Center Surround Index at \\textbf{Mesopic 1} conditions')
ax.set_ylabel('Center Surround Index at \\textbf{Mesopic 2} conditions')
ax.set_aspect('equal')
...
plt.savefig('/home/ycan/Documents/notes/2018-03-15/mesomesoCSIchange.png',
            dpi=300)
plt.show()
...
np.savez('/home/ycan/Downloads/csiplotting_mesomeso.npz',
         cells=cells,
         bias=bias,
         include=include,
         colors=colors,
